                ...
                <div class="content content-boxed">
                        ...
                        <div class="bg-image" style="background-image: url('assets/img/photos/photo25@2x.jpg');">
                            <div class="block-content bg-primary-dark-op clearfix">
                                ...
                                <div class="pull-left push-15-t push-15-l">
                                    ...
                                    <h3 class="h5 text-white-op"><em>Список движений</em></h3>
                                </div>
                            </div>
                        </div>
                        <!-- END Basic Info -->
                    ...
                    <div class="block">
                        <div class="block-header">
                            <h3 class="block-title"> <small>Список движений</small></h3>
                        </div>
                        <div class="block-content block-content-narrow">
                                    <form class="form-horizontal" action="/move" method="get">
                                        
                                        <div class="form-group">
                                            <div class="col-md-8">
                                                <div class="input-daterange input-group" data-date-format="dd.mm.yyyy">
                                                    <input class="form-control" type="text" id="example-daterange1" name="daterange1" placeholder="От">
                                                    <span class="input-group-addon"><i class="fa fa-chevron-right"></i></span>
                                                    <input class="form-control" type="text" id="example-daterange2" name="daterange2" placeholder="До">
                                            ...
                                            <div class="col-xs-12">
                                                <div class="checkbox">
                                                    <label for="example-checkbox1">
                                                        <input type="checkbox" id="example-checkbox1" name="checkbox" value="true"> экспортировать в excel
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <button class="btn btn-sm btn-primary" type="submit">выполнить</button>
                                            </div>
