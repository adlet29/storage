        ...
        <div id="page-container" class="sidebar-l sidebar-o side-scroll header-navbar-fixed">
            ...
            <main id="main-container">
                ...
                <div class="content content-boxed">
                        ...
                        <div class="bg-image" style="background-image: url('assets/img/photos/photo25@2x.jpg');">
                            <div class="block-content bg-primary-dark-op clearfix">
                                ...
                                <div class="pull-left push-15-t push-15-l">
                                    ...
                                    <h3 class="h5 text-white-op"><em>{{$userInfo['fio'] . ' (Руководитель склада #' . $userInfo['store_id'] .')'}}</em></h3>
                                </div>
                            </div>
                        </div>
                        <!-- END Basic Info -->
                    ...
                    <div class="block">
                        <div class="block-header">
                            <h3 class="block-title"> <small>Список оборудование</small></h3>
                        </div>
                            ...
                            <table class="table table-bordered table-striped js-dataTable-full-pagination">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="hidden-xs" style="width: 15%;">Редактировать</th>
                                        <th class="text-center" style="width: 10%;">Отправить</th>
                                    </tr>
                                </thead>
                                <tbody>
                                <?php $cnt = 1; ?>
                                @foreach ($userInfo['items'] as $value)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <form action="/edit" method="put">
                                                    <button class="btn btn-xs btn-default" type="submit" value="{{$value['id']}}" data-toggle="tooltip" title="Редактировать"><i class="fa fa-edit fa-2x"></i></button>
                                                </form>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <form action="/send/{{$value['id']}}" method="get">
                                                    <button class="btn btn-xs btn-default" type="submit" data-toggle="tooltip" title="отправка на склад #{{($userInfo['store_id'] == 1) ? 2 : 1}}"><i class="fa fa-send-o fa-2x"></i></button>
                                                </form>
                                            </div>
                                        </td>
                                    </tr>
